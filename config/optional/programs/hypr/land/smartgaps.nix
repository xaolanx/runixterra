{
  ...
  inherit (config.hj.rum.desktops.hyprland.settings.general) gaps_in gaps_out border_size;
  inherit (config.hj.rum.desktops.hyprland.settings.decoration) rounding;
