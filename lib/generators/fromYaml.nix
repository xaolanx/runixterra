# Taken from https://github.com/SenchoPens/fromYaml/blob/main/fromYaml.nix
/*
...
{lib ? (import <nixpkgs> {}).lib, ...}: let
  ...
  in
    if is singleQuotedString
    then contentOf singleQuotedString
    else if is doubleQuotedString
    then contentOf doubleQuotedString
    else if is abbreviatedList
    then parseAbbreviatedListContent (contentOf abbreviatedList)
    else value;
